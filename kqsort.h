...
static __inline int MEDIAN(const SORT_TYPE *dst,
                           const int a,
                           const int b,
                           const int c)
{
...
static __inline int BINARY_INSERTION_FIND(SORT_TYPE *dst,
                                          const SORT_TYPE x,
                                          const int size)
{
    int l, c, r;
...
static __inline int QUICK_SORT_PARTITION(SORT_TYPE *dst,
                                         const int left,
                                         const int right,
                                         const int pivot)
{
